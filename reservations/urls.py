...
from .views import ReservationViewSet, ClientListView, PaiementViewSet
from . import views
...
urlpatterns = [
    ...
    path('stats/reservations-mensuelles/', reservations_par_mois, name='reservations-mensuelles'),
    path('stats/revenus-destinations/', revenus_par_destination, name='revenus-destinations'),
